...
# Create the filing analyzer agent
filing_analyzer_agent = Agent(
    ...
    2. Business Analysis
       - Major business segments performance
       - Geographic market analysis
       - Key growth drivers or challenges
       
    3. Risk Assessment
       - Key risk factors identified
       - Changes in risk factors from previous filings
    ...
    Format your analysis in a clear, structured manner with sections for each of these areas.
    """,
    tools=[fetch_sec_filings]
)

def analyze_company_filings(ticker: str) -> str:
    """
    Analyze SEC filings for a given company ticker and return a comprehensive report.
    
    Args:
        ticker (str): The stock ticker symbol (e.g., 'AAPL' for Apple)
        
    Returns:
        str: A detailed analysis report of the company's SEC filings
    """
    prompt = f"""
    Please analyze the SEC filings for {ticker} and provide a comprehensive report including:
    1. Key financial metrics and their trends
    2. Business segment analysis
    3. Risk factors and management's discussion
    4. Your assessment of the company's financial health
...
if __name__ == "__main__":
    # Example usage
    ticker_symbol = "AAPL"
    print(f"\nAnalyzing SEC filings for {ticker_symbol}...")
    analysis = analyze_company_filings(ticker_symbol)
    print("\nAnalysis Report:")
    print("=" * 80)
    print(analysis) 